    ...
    <main class="areaPage" id="main-content">
        ...
        <section class="about-area-parent"> 
                ...
                <div class="estepona-a-charming">
                    Its name is derived from an Arabic word, hoxán, meaning "rough" or "bitter" place. 
                    It seems a curious description to give to such a tranquil and beautiful spot, 
                    and even more curious that the Moors should establish a settlement in a place they presumably did not care for. 
                    But they did, and in common with other inland villages such as Istán, 
                    it was allowed to survive the Christians' embargo on Moors living too close to the sea after the reconquest.
                </div>
        </section>

        <section class="area-photo">
            <img class="area-photo-item" id = "first-area" alt="photo1" src="<?php echo get_template_directory_uri(); ?>/images/ojenpage/area/photo1.webp"> 
            <img class="area-photo-item" alt="photo2" src="<?php echo get_template_directory_uri(); ?>/images/ojenpage/area/photo2.webp">
            <img class="area-photo-item" alt="photo3" src="<?php echo get_template_directory_uri(); ?>/images/ojenpage/area/photo3.webp">
        </section>
        ...
        <section class="history-parent">
            ...
            <div class="text-blocks-history">
                <div class="text-history-part">
                    It is situated beside the Almadán stream above the valley of the rio Real at an altitude of 650ft,
                     hemmed in by the Sierras Blanca and Alpujata. In that, we may have a clue to the Moors' determination
                      to stay in spite of their apparent antipathy, for both ranges of mountains have long been known as rich sources
                       of talc, nickel, iron and lead. This mineral wealth put the area in the forefront of the Spanish industrial 
                       revolution of the 19th Century.
                </div> 
                <div class="text-history-part2">
                    Newer, more affluent houses rise into the hills around the stunted, almost invisible vestigial remains of 
                    the Moorish castle which in its heyday dominated the skyline. The village survived the reconquest, 
                    but the castle predictably did not. The few stones that are left are now scattered among weeds and rough grass,
                     home only to insects and beetles, and scarcely worth the climb to see.
                </div>
                <div class="text-history-part3">
                    Close by, in the Serrania de Ronda, is the Refugio de Juanar. Originally the private hunting lodge of the wealthy
                     Larios family, and a favoured retreat of King Alfonso XIII, this former Parador is now a private hotel popular with 
                     tourists and hunters. General Charles de Gaulle stayed here for two weeks in June 1970 at the end of a Spanish tour
                      to finish his memoirs, clearly inspired by the scenery and surround. For the Serrania is still very much a hunting 
                      reserve where ibex, wildcats and eagles abound. It is also a favourite with ramblers and hikers who come to relish 
                      the pure mountain air and climb to the peak of La Concha for the stunning views of Marbella and the coast 3000 feet below. 
                      Guy Hunter Watts describes the Los Cuchillos walk which also starts from the Refegio  
                </div>
        ...
        <section class="photo-gallery-parent">
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/ojenpage/entertainment/art1.webp">
                <div class="name-art-gallery">Salduna Beach</div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/ojenpage/entertainment/art2.webp">
                <div class="name-art-gallery">Trocadero Estepona</div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/ojenpage/entertainment/art3.webp">
                <div class="name-art-gallery">Spiler Beach Club</div>
            </div>
            <div class="photo-gallery-group"  id="last-enter-ph">
                <img class="photo-gallery-item"  alt="" src="<?php echo get_template_directory_uri(); ?>/images/ojenpage/entertainment/art4.webp">
        ...
        <section class="photo-gallery-parent">
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/ojenpage/restaurants/rest1.webp">
            ...
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/ojenpage/restaurants/rest2.webp">
                <div class="name-and-desc"> 
            ...
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/ojenpage/restaurants/rest3.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">Trocadero Estepona</div>
            ...
            <div class="photo-gallery-group"  id="last-rest-ph">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/ojenpage/restaurants/rest4.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">Salduna Beach</div>
        ...
        <section class="photo-gallery-parent">
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/ojenpage/golf/golf1.webp">
                <div class="name-and-desc"> 
            ...
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/ojenpage/golf/golf2.webp">
                <div class="name-and-desc"> 
            ...
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/ojenpage/golf/golf3.webp">
                <div class="name-and-desc"> 
            ...
            <div class="photo-gallery-group"  id="last-golp-ph">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/ojenpage/golf/golf4.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">El Paraiso Golf Club</div>
                    <div class="descr-name-gallery">7:00 AM - 7:30 PM</div>
                </div>
        ...
        <section class="photo-gallery-parent">
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/ojenpage/sport/sport1.webp">
                <div class="name-art-gallery">Windsurfing</div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/ojenpage/sport/sport2.webp">
                <div class="name-art-gallery">Kite surfing</div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/ojenpage/sport/sport3.webp">
                <div class="name-art-gallery">Surfing</div>
            </div>
            <div class="photo-gallery-group"  id="last-sport-ph">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/ojenpage/sport/sport4.webp">
        ...
        <section class="invest-parent">
            <div class="invest-column"> 
                <div class="text-invest">Why you should invest in Ojen</div>


                <div class="mob-person">
                    <img class="peop-mob-icon" alt="" src="<?php echo get_template_directory_uri(); ?>/images/ojenpage/people/peop-mob1.svg">
            ...
            <div class="people-column">
                <img class="people-photo" alt="" src="<?php echo get_template_directory_uri(); ?>/images/ojenpage/people/people1.png">
                <img class="people-photo2" alt="" src="<?php echo get_template_directory_uri(); ?>/images/ojenpage/people/people2.png">
                <img class="people-photo2" alt="" src="<?php echo get_template_directory_uri(); ?>/images/ojenpage/people/people3.png"> 
            </div>
        </section>
        ...
        <div class="top-projects">Top projects</div>
			<section class="projects-parent"> 
				...
				<div class="top-project-name">Explore Top projects in Ojen
			...
			<div class="projects-card-group-areas" id="projectsAreaOjen"></div>
			<span class="projects-card-group-text" id="projectsAreaTextOjen"></span>
		</section>
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  async function fetchSecondaryProjectsArea() {
    try {
			...
			const projectsAreaText = document.getElementById("projectsAreaTextOjen");
