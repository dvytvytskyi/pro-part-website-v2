    ...
    <main class="areaPage" id="main-content">
        ...
        <section class="headerbenahavis">
            <div class="AreaContent">
              ...
              <div class="estepona">Benahavis</div> 
        ...
        <section class="about-area-parent"> 
                ...
                <div class="estepona-a-charming">
                    The municipality of Benahavis is situated at the western end of the Costa del Sol,
                    slightly inland and between Estepona and Marbella. Benahavis has great connections 
                    and is within easy access to national and international connections in Malaga as well
                    as other popular destinations on the Costa del Sol. It is very different to other 
                    Costa del Sol resorts – at the heart of the extensive area there is the tranquil and traditional 
                    village of Benahavis set in the mountains and which has maintained the Andalusian feel.
                </div>
        </section>

        <section class="area-photo">
            <img class="area-photo-item" id = "first-area" alt="photo1" src="<?php echo get_template_directory_uri(); ?>/images/benahavispage/area/photo1.webp"> 
            <img class="area-photo-item" alt="photo2" src="<?php echo get_template_directory_uri(); ?>/images/benahavispage/area/photo2.webp">
            <img class="area-photo-item" alt="photo3" src="<?php echo get_template_directory_uri(); ?>/images/benahavispage/area/photo3.webp">
        </section>
        ...
        <section class="history-parent">
            ...
            <div class="text-blocks-history">
                <div class="text-history-part">
                    Nestled in the mountains of the Costa del Sol, Benahavís is a picturesque Andalusian village with a deep history and rich cultural 
                    heritage. Known for its whitewashed houses, stunning natural landscapes, and a reputation as the "Gastronomic
                     Corner of the Costa del Sol," Benahavís has a history that reflects the cultural mosaic of southern Spain. 
                     From Moorish origins to its thriving present-day community, Benahavís embodies the spirit of Andalusia—a blend of tradition,
                    culture, and a passion for good food.
                </div>
                
                <div class="text-history-part2">
                    The history of Benahavís dates back to the Moorish period, when the region was part of the Taifa of Marbella during the reign
                     of the Caliphate of Córdoba. The Moors built Montemayor Castle in the 10th century, which became a key strategic
                      site due to its elevated location. Perched high on a hilltop, the castle offered commanding views of the coastline, 
                      providing protection against potential invasions. Even today, remnants of Montemayor Castle stand as a testament to 
                      the village's Moorish heritage, and visitors can still enjoy breathtaking panoramic views from the castle ruins, 
                      stretching from the Mediterranean Sea to the African coast on clear days.
                </div>
                <div class="text-history-part3">
                    The name "Benahavís" itself is derived from the Arabic "Ben al Havis," meaning "son of Havis," which suggests that the village 
                    may have been named after an important Moorish leader or landowner. During the Reconquista—the Christian reconquest 
                    of the Iberian Peninsula—Benahavís witnessed numerous battles as the Catholic monarchs sought to reclaim territory from the Moors.
                     The fall of nearby Marbella in 1485 marked a turning point for Benahavís, which subsequently came under Christian rule. Over time, 
                     the village transformed, embracing a blend of Moorish and Christian influences that shaped its culture and architecture.
                </div>
        ...
        <!-- <section class="top-entertainment-parent">
            ...
            <div class="top-entertainment-text">
                Costa Del Sol boasts several top-tier golf clubs,  with stunning views of the Mediterranean and mountains.
                 These courses offer excellent facilities and challenges for golfers of all skill levels, making Costa Del Sol
                  a prime destination for golf lovers.
            </div> 
        </section> -->

        <!-- <section class="photo-gallery-parent">
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/src/pages/AreaPage/assets/images/entertainment/art1.webp">
                <div class="name-art-gallery">Salduna Beach</div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/src/pages/AreaPage/assets/images/entertainment/art2.webp">
                <div class="name-art-gallery">Trocadero Estepona</div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/src/pages/AreaPage/assets/images/entertainment/art3.webp">
                <div class="name-art-gallery">Spiler Beach Club</div>
            </div>
            <div class="photo-gallery-group"  id="last-enter-ph">
                <img class="photo-gallery-item"  alt="" src="<?php echo get_template_directory_uri(); ?>/src/pages/AreaPage/assets/images/entertainment/art4.webp">
        ...
        <!-- <section class="photo-gallery-parent">
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/src/pages/AreaPage/assets/images/restaurants/rest1.webp">
            ...
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/src/pages/AreaPage/assets/images/restaurants/rest2.webp">
                <div class="name-and-desc"> 
            ...
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/src/pages/AreaPage/assets/images/restaurants/rest3.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">Trocadero Estepona</div>
            ...
            <div class="photo-gallery-group"  id="last-rest-ph">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/src/pages/AreaPage/assets/images/restaurants/rest4.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">Salduna Beach</div>
        ...
        <section class="top-entertainment-parent"> 
            ...
            <div class="top-entertainment-text">
                Costa Del Sol boasts several top-tier golf clubs,  with stunning views of the Mediterranean and mountains. 
                These courses offer excellent facilities and challenges for golfers of all skill levels,
                 making Costa Del Sol a prime destination for golf lovers.
            </div> 
        </section>

        <section class="photo-gallery-parent">
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/benahavispage/golf/golf1.webp">
                <div class="name-and-desc"> 
            ...
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/benahavispage/golf/golf2.webp">
                <div class="name-and-desc"> 
            ...
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/benahavispage/golf/golf3.webp">
                <div class="name-and-desc"> 
            ...
            <div class="photo-gallery-group"  id="last-golp-ph">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/benahavispage/golf/golf4.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">El Paraiso Golf Club</div>
                    <div class="descr-name-gallery">7:00 AM - 7:30 PM</div>
                </div>
        ...
        <section class="top-entertainment-parent"> 
            ...
            <div class="top-entertainment-text">
                In Costa Del Sol , water sports offer a wide range of activities. You can enjoy kite surfing, windsurfing, surfing, and SUP boarding. 
                Diving and snorkeling are also popular due to the clear waters and rich marine life. Fishing enthusiasts can choose between sea and freshwater fishing. 
        ...
        <section class="photo-gallery-parent">
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/benahavispage/sport/sport1.webp">
                <div class="name-art-gallery">Windsurfing</div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/benahavispage/sport/sport2.webp">
                <div class="name-art-gallery">Kite surfing</div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/benahavispage/sport/sport3.webp">
                <div class="name-art-gallery">Surfing</div>
            </div>
            <div class="photo-gallery-group"  id="last-sport-ph">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/benahavispage/sport/sport4.webp">
        ...
        <section class="invest-parent">
            <div class="invest-column"> 
                <div class="text-invest">Why you should invest in Benahavis</div>


                <div class="mob-person">
                    <img class="peop-mob-icon" alt="" src="<?php echo get_template_directory_uri(); ?>/images/benahavispage/people/peop-mob1.svg">
            ...
            <div class="people-column">
                <img class="people-photo" alt="" src="<?php echo get_template_directory_uri(); ?>/images/benahavispage/people/people1.png">
                <img class="people-photo2" alt="" src="<?php echo get_template_directory_uri(); ?>/images/benahavispage/people/people2.png">
                <img class="people-photo2" alt="" src="<?php echo get_template_directory_uri(); ?>/images/benahavispage/people/people3.png"> 
            </div>
        </section>
			<div class="top-projects">Top projects</div>
			<section class="projects-parent"> 

				<div class="top-project-name">Explore Top projects in Benahavis
				...
				<div class="projects-card-group-areas" id="projectsAreaBenahavis"></div>
				<span class="projects-card-group-text" id="projectsAreaTextBenahavis"></span>
			</section>
    </main>
    <script>
  ...
  footerContainer.appendChild(Footer());
    ...
    try {
            ...
            const projectsContainer = document.getElementById(
                "projectsAreaBenahavis"
            );
			const projectsAreaText = document.getElementById("projectsAreaTextBenahavis");
