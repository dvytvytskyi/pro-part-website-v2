...
<main id="main-content"><div class="service"><div class="service-top">
    ...
    <div class="service-top-buttons"><a class="service-top-button">
      ...
      </a><a class="service-top-button" target="_blank" href="https://twitter.com/intent/tweet?text=https%3A%2F%2Fnew-site.pro-part.es%2F%23consulting-service">
        <img src="<?php echo get_template_directory_uri(); ?>/icons/twitter.svg" alt="twitter">
      </a><a class="service-top-button" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fnew-site.pro-part.es%2F%23consulting-service">
      ...
      <h1 class="service-title">Legal services</h1>
    <p class="service-grey-text">Our firm specializes in providing comprehensive legal services tailored to meet the diverse needs of individuals and businesses, with a particular emphasis on real estate, company administration, tax advisory, labor law, and banking services. Our expertise spans across different sectors, ensuring that clients receive holistic, timely, and efficient solutions for all their legal, tax, and financial matters in Spain.<br>        Real Estate Legal Services</p><p class="service-grey-text">We have extensive experience in managing real estate transactions for both residential and commercial properties. Our services are designed to navigate clients through the complexities of the Spanish property market, ensuring that all legal, tax, and regulatory aspects are fully addressed.</p><ul class="service-competencies"><li class="service-grey-text li-test"><span class="service-competencies-span">Legal Advice &amp; Structuring: </span>
        We offer expert legal advice that covers all stages of real estate transactions. Our team conducts in-depth due diligence, identifying potential risks and providing actionable insights to structure transactions that minimize legal exposure and optimize outcomes. Our understanding of local regulations and real estate market dynamics allows us to facilitate smooth and legally sound acquisitions.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Tax Counseling: </span>
        We assist our clients in optimizing tax liabilities associated with property acquisition, ownership, and disposal. Our services include tax structuring, identifying exemptions or incentives available under Spanish law, and ensuring that all aspects of property ownership are compliant with national and regional tax legislation. This includes advice on municipal taxes such as the Impuesto sobre Bienes Inmuebles (IBI) and Plusvalía.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Financing &amp; Guarantees: </span>
        Our firm is adept at helping clients secure financing for real estate purchases. We liaise with banks, mortgage lenders, and private financial institutions to secure favorable financing terms. Additionally, we assist in setting up collateral agreements and guarantees to protect our clients' interests.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Risk Assessment: </span>
        Given the inherent risks in property transactions, we conduct a thorough risk assessment that covers legal, financial, and operational aspects. Our services include title searches, zoning and planning verifications, and evaluating potential environmental liabilities.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Commercial Negotiations &amp; Transaction Support: </span>
        Our team actively participates in commercial negotiations, representing our clients’ best interests when dealing with sellers, buyers, developers, and other stakeholders. From drafting and reviewing contracts to the registration of deeds, we provide comprehensive transaction support to ensure all elements are correctly executed.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Cross-Border Transactions: </span>
        For non-residents and foreign investors, we facilitate cross-border real estate transactions, ensuring compliance with Spanish regulations and addressing any double taxation concerns through effective tax treaty planning.
        </li><div class="service-list"></div><h2 class="service-competencies-title">Tax, Financial, and Accounting Services</h2><p class="service-grey-text">Our firm provides a complete range of tax advisory, financial planning, and accounting services to both residents and non-residents, with a focus on optimizing our clients' fiscal positions and ensuring regulatory compliance.<br>      </p><h2 class="service-competencies-title"></h2><li class="service-grey-text li-test"><span class="service-competencies-span">Tax Consulting for Individuals and Businesses: </span>
       Our tax consulting services extend beyond filing and compliance. We offer strategic tax planning, leveraging local regulations and international treaties to minimize liabilities. Whether it involves corporate income tax, value-added tax (VAT), or withholding taxes, our team ensures that our clients are taking advantage of all available tax benefits and exemptions.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Corporate Tax Planning &amp; Restructuring: </span>
        We provide bespoke advice on corporate tax planning, ensuring that companies structure their operations to maximize efficiency and minimize tax exposure. This includes advising on mergers, acquisitions, spin-offs, and other corporate restructuring processes. Our expertise includes cross-border issues, allowing foreign companies to operate in Spain without falling afoul of Spanish tax laws.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Tax Representation &amp; Dispute Resolution: </span>
        Our firm represents clients before the Spanish tax authorities, offering advocacy in audits, disputes, and appeals. We have successfully defended clients in complex tax matters, including challenges related to corporate income tax, VAT, and other indirect taxes.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Corporate Reporting &amp; Compliance: </span>
        We ensure that all statutory obligations are met, including the preparation and legalization of books of accounts and annual reports. Our services include liaising with government authorities such as the Tax Agency (Agencia Tributaria), Commercial Registry, and the Real Estate Registry to ensure full compliance with Spanish corporate law.
        </li><h2 class="service-competencies-title"></h2><h2 class="service-competencies-title">Company Administration &amp; Corporate Governance</h2><p class="service-grey-text">Effective company administration is essential for smooth business operations. We offer a broad range of services that ensure the comprehensive management of corporate affairs:<br>      </p><h2 class="service-competencies-title"></h2><li class="service-grey-text li-test"><span class="service-competencies-span">Payments Management: </span>
       We manage the financial obligations of our clients, from supplier invoices to salary payments, taxes, and other operational expenses. This service is supported by a robust internal control system that ensures transparency and accountability in all transactions.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Lease &amp; Insurance Management: </span>
        Our services include the management of commercial and residential lease agreements on behalf of our clients, as well as insurance policy management. We ensure all lease terms are adhered to, and all policies provide adequate coverage against potential risks.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Corporate Governance &amp; Compliance: </span>
       We assist clients with establishing effective corporate governance structures. Our services include drafting internal policies, ensuring compliance with data protection laws (such as the General Data Protection Regulation - GDPR), and maintaining up-to-date corporate records.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Regulatory Liaison: </span>
       We interact with notaries, banks, and regulatory authorities to handle administrative matters, such as registering company changes, paying fees, and preparing corporate resolutions.
        </li><h2 class="service-competencies-title"></h2><h2 class="service-competencies-title">Labor Law &amp; Human Resources Management</h2><p class="service-grey-text">Labor law is an integral part of our practice, and we provide a comprehensive suite of services to assist employers and employees in understanding and complying with labor regulations:<br>      </p><h2 class="service-competencies-title"></h2><li class="service-grey-text li-test"><span class="service-competencies-span">Labor Relations &amp; Human Resources Consulting: </span>
       Our firm advises clients on labor law compliance, ensuring that employment contracts, workplace policies, and HR practices meet all legal requirements. We draft employment contracts, advise on employee benefits, and assist with onboarding and termination procedures.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Social Labor Audits &amp; Compliance Review: </span>
       We conduct comprehensive social labor audits, assessing our clients’ compliance with employment laws and social security obligations. These audits help identify potential liabilities and areas where practices can be improved.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Representation in Labor Courts &amp; Dispute Resolution: </span>
       Our experienced labor law attorneys represent clients in labor courts, providing effective representation in disputes related to unfair dismissal, wage claims, discrimination, and other employment-related issues. We also facilitate conciliation and arbitration processes to resolve conflicts before they escalate to litigation.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Collective Bargaining &amp; Union Relations: </span>
       We represent clients during collective bargaining negotiations with trade unions, ensuring that collective labor agreements are negotiated in a manner that aligns with our clients' interests while maintaining compliance with labor laws.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Immigration &amp; Foreign Workers: </span>
       Our firm provides advisory services related to foreign employees, including work permits, residency applications, and compliance with Spanish immigration law.
        </li><h2 class="service-competencies-title"></h2><h2 class="service-competencies-title">Bank Account Opening for Non-Residents</h2><p class="service-grey-text">Opening a bank account in Spain for non-residents has become increasingly complex due to stricter anti-money laundering (AML) policies and evolving banking regulations. We assist clients throughout the account opening process, leveraging our expertise and banking relationships to streamline this often challenging task.<br>      </p><h2 class="service-competencies-title"></h2><li class="service-grey-text li-test"><span class="service-competencies-span">Comprehensive Consultation: </span>
       We provide consultation on all aspects of opening a bank account, advising clients on the documentation requirements, timelines, and potential challenges involved.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Document Collection &amp; Sworn Translation:: </span>
       Our team assists in gathering all necessary documents, organizing sworn translations, and ensuring that everything is prepared to meet the bank’s standards.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Bank Liaison &amp; Account Opening Assistance: </span>
       We work with reliable banking institutions and accompany clients throughout the process to ensure a successful outcome. Our familiarity with banking procedures and compliance requirements helps facilitate smooth account openings.
        </li><h2 class="service-competencies-title"></h2><h2 class="service-competencies-title">Solutions for Effective Management</h2><p class="service-grey-text">Our commitment is to provide our clients with end-to-end solutions that address their legal, tax, and business needs efficiently. Our goal is to simplify the complexity of doing business in Spain, ensuring clients are fully informed and compliant with all applicable regulations. Whether you are navigating real estate transactions, managing corporate affairs, addressing labor law concerns, or opening a bank account as a non-resident, our expertise provides peace of mind and effective results.<br>      </p><h2 class="service-competencies-title"></h2><p class="service-grey-text">Our team of skilled professionals is ready to support you in achieving your objectives. For further information or personalized assistance, please contact us, and we will be happy to arrange a consultation.<br>      </p><div class="service-wrapper"></div></ul></div><div class="service-right"><div class="service-right-top">
