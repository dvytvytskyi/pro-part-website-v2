<?php
/* Template Name: Polygons New Building */
?>
    ...
    <section class="newbuildingblock">
        <div class="filterPropertiesWrapper">
            ...
            <div class="filterPropertiesWrapper__dropdownds">
                <div class="filterPropertiesWrapper__adapriveWrapper">
                ...
                <div id="offPlanSortFilter" class="filterPropertiesWrapper__dropDown">
                        ...
                        <div class="filterPropertiesWrapper__dropDown_header">
                            Sort
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" class="filterPropertiesWrapper__sortSvgFull">
                                <path d="M7 10L12 14L17 10" stroke="#717171" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
                            </svg>
                        </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const Header = () => {
            ...
            fixedMenue.innerHTML = `
                ...
                <a class="button callUsButtonWhite" href="https://wa.me/34695113333?text=Hola,%20me%20interesa%20información%20sobre%20propiedades" target="_blank"></a>
...
//                     if (locationContainer) locationContainer.innerHTML = "";
    ...
    { text: "Rent", url: `${language && "/" + language}/rent?page=1&rent_type=long` },
    {
            ...
            callUsButtonBottom.onclick = () => {
                window.open("https://wa.me/34695113333?text=Hola,%20me%20interesa%20información%20sobre%20propiedades", "_blank");
            };
        ...
        const Footer = () => {
            ...
            phoneElement.href = "https://wa.me/34695113333?text=Hola,%20me%20interesa%20información%20sobre%20propiedades"; phoneElement.target = "_blank";
    ...
    },
    {
        ...
        async function populateSearchDropdown() {
            const params = new URLSearchParams({
                accessKey: "rijVnGe6lBwcsWop",
                secretKey: "0FnSmmqRcM1X0V5y28Mx9rMYyo2mQdVt",
                isPagination: "false",
            });
            ...
            try {
                const response = await fetch(
                    `https://crm.server.pro-part.es/api/v1/off-plan/integration/projects?${params.toString()}`,
                    {
                        method: "GET",
                        headers,
                    }
                ...
                const inputField = document.getElementById("offPlanFilterInputName");

                dropdownList.innerHTML = "";

                projects?.forEach((project) => {
                    const item = document.createElement("div");
                    item.id = `dropdownItem-${project._id}`;
                    ...
                    item.addEventListener("click", function () {
                        ...
                        updateQueryParameter("projectName", project.name);
                        dropdownList.innerHTML = "";
                        dropdownBody.classList.remove("active");
        ...
        function paginationOffPlan(totalPages, currentPage = 0) {
        ...
        function offPlanDropDownPropertyType() {
            ...
            function syncPropertyTypesWithQuery() {
                ...
                selectedTypes = typesFromQuery
                    ? decodeURIComponent(typesFromQuery).split(",").map((type) => type.trim())
                    : [];
...
//         window.addEventListener("popstate", offPlanDropDownLocation);
        ...
        function offPlanDropDownSort() {
            ...
            if (dropdownContainer) {
                ...
                const sortValues = [
                    "Size Smaller to Bigger",
                    "Size Bigger to Smaller",
                    "Newly added",
                ];
        ...
        function offPlanDropDownPropertyTypeMobile() {
            ...
            function handleTypeSelection(typeText) {
                ...
                // Обновляем стили и строку запроса
                updateTypeStyles();
                updateQueryParameter("propertyTypes", selectedTypes.length ? selectedTypes.join(",") : null);
            ...
            function syncTypesWithQuery() {
                const urlParams = new URLSearchParams(window.location.search);
                const typesFromQuery = urlParams.get("propertyTypes");
...
//         window.addEventListener("popstate", offPlanDropDownLocationMobile);
        ...
        function renderValueFilterFromQueryOffPlan() {
            ...
            // IDs for displaying filters
            const bedroomsContainer = document.getElementById("selectValueOffPlanBedrooms");
            const priceContainer = document.getElementById("selectValueOffPlanPrice");
            const sizeContainer = document.getElementById("selectValueOffPlanSize");
            const propertyTypeContainer = document.getElementById("selectValueOffPlanPropertyType");
            const handoverContainer = document.getElementById("selectValueOffPlanHandover");
//             const locationContainer = document.getElementById("selectValueOffPlanFilterLocation");
            ...
            // Property type
            if ((queryParams.has("minType") || queryParams.has("maxType")) && propertyTypeContainer) {
                ...
                if (TypeText) {
                    addFilterItem(propertyTypeContainer, TypeText);
                }
            }
...
//             }
            ...
            function clearFilterValues() {
                ...
                if (handoverContainer) handoverContainer.innerHTML = "";
//                 if (locationContainer) locationContainer.innerHTML = "";
//                 if (propertyTypeContainer) locationContainer.innerHTML = "";
            }
        ...
        async function fetchOffPlanProjects() {
            ...
            const params = new URLSearchParams({
                ...
                size: queryParams.get("size") || "15",
            });

            if (queryParams.has("subAreas")) params.append("locations", queryParams.get("subAreas"));
            if (queryParams.has("shareId")) params.append("shareId", queryParams.get("shareId"));
            if (queryParams.has("developer")) params.append("developer", queryParams.get("developer"));
            if (queryParams.has("minPrice")) params.append("minPrice", queryParams.get("minPrice"));
            if (queryParams.has("maxPrice")) params.append("maxPrice", queryParams.get("maxPrice"));
            if (queryParams.has("minSize")) params.append("minSize", queryParams.get("minSize"));
            if (queryParams.has("maxSize")) params.append("maxSize", queryParams.get("maxSize"));
            if (queryParams.has("bedrooms")) params.append("bedrooms", queryParams.get("bedrooms"));
            if (queryParams.has("projectName")) params.append("name", queryParams.get("projectName"));
            if (queryParams.has("startHandover")) params.append("startHandover", queryParams.get("startHandover"));
            if (queryParams.has("endHandover")) params.append("endHandover", queryParams.get("endHandover"));
            console.log(params.toString());
            // Сортировка
            if (queryParams.has("sort")) {
                const sortValue = queryParams.get("sort");
                switch (sortValue) {
                    case "Size Smaller to Bigger":
                        params.append("sortField", "generalInfo.size");
                        params.append("sortDirection", "ASC");
                        break;
                    case "Size Bigger to Smaller":
                        params.append("sortField", "generalInfo.size");
                        params.append("sortDirection", "DESC");
                        break;
                    case "Handover Sooner to Later":
                        params.append("sortField", "generalInfo.handover");
                        params.append("sortDirection", "ASC");
                        break;
                    case "Newly added":
            ...
            // Формирование тела запроса: массив без ключа
            const projectIdsBase64 = sessionStorage.getItem("projectIdsBase64OffPlan");
            const body = projectIdsBase64
                ? projectIdsBase64.split(",").map(id => id.trim())
                : [];

            try {
                const response = await fetch(
                    `https://crm.server.pro-part.es/api/v1/off-plan/integration/projects/list?${params.toString()}`,
                    {
                        method: "POST",
                        headers: {
                            "Content-Type": "application/json",
                    
                        body: JSON.stringify(body), // Отправка массива напрямую
                    }
                );
                ...
                // Отображение данных
                const totalOffPlan = document.getElementById("totalOffPlan");
                totalOffPlan.textContent = `projects: ${data.totalProjects}`;
        ...
        // Добавляем обработчик клика на кнопку с id "shareProjectsBtn"
        document.getElementById("shareProjectsBtn").addEventListener("click", shareProjects);
        ...
        function createProjectCard(project) {
            ...
            card.addEventListener('click', function (event) {
                ...
                card.href = `${language && "/" + language}/new-building?project=${project._id}`;
            ...
            const isFavorite = savedProjects.some(p => p._id === project._id);
            ...
            card.innerHTML = `
                    ...
                    <div class="frame-container">
                        ...
                        <div class="marein-natura-parent">
                            ...
                            <div class="marbella-spain">${generalInfo.province}</div>
                        </div>
                        <div class="parent">
                            <div class="marein-natura">€ ${units[0].price.toLocaleString()}</div>
                            <div class="m21">€ ${Math.round(units[0].price / units[0].size).toLocaleString()} m²</div>
                        </div>
                        </div>
                        <div class="frame-item"></div>
                        <div class="developer-name-parent">
                        <div class="off-plan">${units[0].type}</div>
    ...
    async function shareProjects() {
        const projectIdsBase64 = sessionStorage.getItem("projectIdsBase64OffPlan");
        const offPlanProjects = projectIdsBase64
            ? projectIdsBase64.split(",").map(id => id.trim())
            : [];
        ...
        const shareButton = document.getElementById("shareProjectsBtn");
        ...
        try {
            ...
            if (!response.ok) {
                throw new Error("Failed to share projects");
            }
            ...
            try {
                ...
                const generatedLink = responseData._id
                    ? `https://pro-part.es/polygons-new-building/?shareId=${responseData._id}`
                    : "";

                if (generatedLink) {
                    await navigator.clipboard.writeText(generatedLink);
                    console.log("Ссылка скопирована:", generatedLink);
                } else {
                    console.warn("Ссылка не сгенерирована:", responseText);
                }
            } catch (jsonError) {
