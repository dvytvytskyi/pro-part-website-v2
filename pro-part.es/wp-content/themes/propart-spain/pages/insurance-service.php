...
<main id="main-content"><div class="service"><div class="service-top">
    ...
    <div class="service-top-buttons"><a class="service-top-button">
      ...
      </a><a class="service-top-button" target="_blank" href="https://twitter.com/intent/tweet?text=https%3A%2F%2Fnew-site.pro-part.es%2F%23insurance-service">
        <img src="<?php echo get_template_directory_uri(); ?>/icons/twitter.svg" alt="twitter">
      </a><a class="service-top-button" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fnew-site.pro-part.es%2F%23insurance-service">
      ...
      <h1 class="service-title">Insurance</h1>
    <p class="service-grey-text">Whether you are planning to obtain a national visa, establish residence, or study in Spain, ProPart provides a full range of insurance solutions tailored to your needs. Our experts assist in choosing the right insurance company and issuing policies for health, real estate, and automobile coverage. In this overview, we detail how ProPart can help protect your investment, health, and property while providing peace of mind during your time in Spain.</p><ul class="service-competencies"><div class="service-list"></div><h2 class="service-competencies-title">Real Estate Insurance in Spain</h2><p class="service-grey-text">Spain has become a popular destination for foreign real estate investors, with its attractive climate, rich culture, and stable property market. However, investing in Spanish real estate comes with risks such as natural disasters, theft, and potential legal title issues. Real estate insurance helps mitigate these risks, minimizing financial losses in the event of unforeseen incidents.<br>      </p><h2 class="service-competencies-title"></h2><h2 class="service-competencies-title">Why Insure Your Real Estate in Spain?</h2><p class="service-grey-text">Investing in Spanish real estate can be highly lucrative, but it also involves specific risks that can lead to significant financial losses if not properly managed. From natural disasters like floods and earthquakes to fires and legal disputes over property ownership, having insurance is an essential safeguard. Insurance policies provide financial security, protecting the value of your property and offering peace of mind to property owners.<br>      </p><h2 class="service-competencies-title"></h2><h2 class="service-competencies-title">Main Types of Real Estate Insurance</h2><li class="service-grey-text-num li-test"><span class="service-competencies-span-num">1. </span><span class="service-text">Buildings Insurance: Covers the structural elements of your property, including walls, roofs, floors, and fixed installations such as kitchen fittings and bathrooms. This insurance ensures your property is covered in case of fire, flooding, or other damage.</span></li><li class="service-grey-text-num li-test"><span class="service-competencies-span-num">2. </span><span class="service-text">Contents Insurance: Protects the movable property inside your home, including furniture, appliances, electronics, and personal belongings. This is particularly important for furnished properties that are rented out to tenants or tourists.</span></li><li class="service-grey-text-num li-test"><span class="service-competencies-span-num">3. </span><span class="service-text">Liability Insurance: Essential for owners renting their property, especially in tourist areas like the Costa del Sol. It covers medical expenses or legal costs if a third party is injured or if there is property damage on your premises.</span></li><li class="service-grey-text-num li-test"><span class="service-competencies-span-num">4. </span><span class="service-text">Legal Assistance: Provides access to legal support in case of disputes involving your property. This includes issues related to tenancy, land ownership, or damages caused by tenants.</span></li><h2 class="service-competencies-title"></h2><h2 class="service-competencies-title">Choosing the Right Real Estate Insurance</h2><p class="service-grey-text">When selecting real estate insurance in Spain, several factors should be considered to ensure your coverage meets your needs:<br>      </p><h2 class="service-competencies-title"></h2><li class="service-grey-text li-test"><span class="service-competencies-span">Coverage Completeness: </span>
       Ensure your policy comprehensively covers major risks, from natural disasters to theft.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Exclusions: </span>
       Carefully read policy terms, especially exclusions, to avoid surprises when filing a claim.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Cost vs. Quality: </span>
       Compare different insurers to find the best balance between premium costs and quality of service.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Deductibles: </span>
       Understand the deductibles (the amount you pay before the insurance kicks in) and choose a level that you are comfortable with.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Reputation of the Company: </span>
       Choose an insurer with a solid reputation and positive customer reviews to ensure reliability.
        </li><h2 class="service-competencies-title"></h2><h2 class="service-competencies-title">Peculiarities of Real Estate Insurance in Spain</h2><h2 class="service-competencies-title"></h2><li class="service-grey-text li-test"><span class="service-competencies-span">Legal Requirements: </span>
        Depending on the region, specific insurance requirements may exist. For instance, properties in areas prone to natural disasters may require additional coverage.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Location-Related Risks: </span>
       The cost of insurance can vary based on the geographical risks, such as earthquake zones or areas prone to flooding.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Tax Considerations: </span>
       Some insurance premiums may be tax deductible, potentially reducing the overall cost of property ownership.
        </li><h2 class="service-competencies-title"></h2><h2 class="service-competencies-title">Health Insurance in Spain</h2><p class="service-grey-text">Health insurance is an important aspect of living in Spain, whether as a resident or a visitor. The Spanish healthcare system, "Sistema Nacional de Salud," is highly regarded for its quality and affordability. However, private health insurance offers additional benefits such as shorter waiting times, personalized care, and access to a wider range of specialists.<br>      </p><h2 class="service-competencies-title"></h2><h2 class="service-competencies-title">Private Health Insurance: An Overview</h2><p class="service-grey-text">Private health insurance in Spain acts as a complement to the public healthcare system. It provides:<br>      </p><h2 class="service-competencies-title"></h2><li class="service-grey-text li-test"><span class="service-competencies-span">Choice of Doctor and Clinic: </span>
        Flexibility to choose specific healthcare professionals and private clinics, which may not be available through the public system.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Urgent Care Access: </span>
       Fast-track access to diagnostic services, specialist consultations, and treatments without extended waiting periods.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Expanded Coverage: </span>
      Access to a broader range of medical services, including specialists and treatments not fully covered by the public system.
        </li><h2 class="service-competencies-title"></h2><h2 class="service-competencies-title">How to Choose Health Insurance in Spain</h2><p class="service-grey-text">When choosing health insurance, consider these key factors:<br>      </p><h2 class="service-competencies-title"></h2><li class="service-grey-text li-test"><span class="service-competencies-span">Coverage: </span>
        Assess your medical needs and ensure that the policy covers the necessary services, including specialist consultations, diagnostics, and surgical procedures.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Cost and Premiums: </span>
       Compare monthly premiums, deductibles, and any additional costs such as co-pays or surcharges to find a policy that offers value without exceeding your budget.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Exclusions: </span>
       Be aware of what the policy does not cover, including pre-existing conditions or certain types of treatment.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Insurance Company Reputation: </span>
       Choose a reputable insurer with a strong track record for customer service and claims management.
        </li><h2 class="service-competencies-title"></h2><h2 class="service-competencies-title">Benefits of Private Health Insurance</h2><h2 class="service-competencies-title"></h2><li class="service-grey-text li-test"><span class="service-competencies-span">Comfort and Personalized Care: </span>
        Private clinics typically offer a higher standard of comfort, with private rooms and attentive service.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Language Support: </span>
       Many private facilities provide multilingual staff, ensuring that language is not a barrier to accessing quality healthcare.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">International Coverage: </span>
        Certain private health insurance plans offer international coverage, a valuable feature for expatriates and frequent travelers.
        </li><h2 class="service-competencies-title"></h2><h2 class="service-competencies-title">Student Insurance in Spain</h2><p class="service-grey-text">For students planning to study in Spain, health insurance is a critical requirement for obtaining a student visa and ensuring their well-being throughout their stay. Here are the main considerations for student insurance:<br>      </p><h2 class="service-competencies-title"></h2><li class="service-grey-text li-test"><span class="service-competencies-span">Visa Requirements: </span>
        The insurance policy must provide comprehensive coverage for medical emergencies, hospitalization, and potential repatriation to the home country. The policy must be valid for the entire duration of the student’s stay.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Specialized Student Policies: </span>
       Some insurance companies offer plans specifically designed for international students, covering the mandatory requirements set by Spanish consulates.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Coverage Essentials: </span>
      Ensure the policy covers emergency medical care, hospitalization, and dental care as needed. Additionally, consider accident, lost baggage, and liability insurance.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Flexibility for Extension: </span>
     If extending your stay, make sure the policy is easy to renew and that the insurer is responsive in case of claims.
        </li><h2 class="service-competencies-title"></h2><h2 class="service-competencies-title">Car Insurance in Spain</h2><p class="service-grey-text">Car insurance is a legal requirement in Spain, and for those living on the Costa del Sol, it is essential for both convenience and protection. Here’s what to consider:<br>      </p><h2 class="service-competencies-title"></h2><h2 class="service-competencies-title">Legal Requirements</h2><li class="service-grey-text li-test"><span class="service-competencies-span">Public Liability Insurance (Seguro de Responsabilidad Civil): </span>
        is the minimum required by law. This basic policy covers damages to third parties but does not include protection for the driver's car or personal injuries.
        </li><h2 class="service-competencies-title"></h2><h2 class="service-competencies-title">Types of Car Insurance</h2><li class="service-grey-text li-test"><span class="service-competencies-span">Third-Party, Fire, and Theft: </span>
        Covers not only third-party liability but also damages resulting from fire and theft.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Fully Comprehensive Insurance (Todo Riesgo): </span>
      This is the highest level of protection, covering all risks including damages to your own vehicle, regardless of who is at fault.
        </li><h2 class="service-competencies-title"></h2><h2 class="service-competencies-title">Factors Affecting Insurance Cost</h2><li class="service-grey-text li-test"><span class="service-competencies-span">Driver Age and Experience: </span>
        Younger drivers typically face higher premiums due to increased risk factors.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Driving History: </span>
      Accidents or violations can significantly increase insurance costs.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Vehicle Type: </span>
      The value, power, and model of the car affect insurance premiums, with high-value cars attracting higher costs.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Region: </span>
     Areas with higher crime or accident rates may have higher premiums due to increased risks.
        </li><h2 class="service-competencies-title"></h2><h2 class="service-competencies-title">Insurance for the Costa del Sol Region</h2><p class="service-grey-text">The Costa del Sol is a picturesque and highly desirable part of Spain, attracting millions of tourists and expatriates each year. This cosmopolitan environment creates a unique demand for tailored insurance solutions, from health and real estate to automobile coverage.<br>      </p><h2 class="service-competencies-title"></h2><h2 class="service-competencies-title">Health Insurance on the Costa del Sol</h2><p class="service-grey-text">For expatriates and tourists, health insurance is particularly important to ensure access to quality care without delays. While public healthcare in Spain is excellent, private insurance is often necessary to access premium services and avoid waiting lists. It also complements a European Health Insurance Card (EHIC), offering additional services that public healthcare may not cover.<br>      </p><h2 class="service-competencies-title"></h2><h2 class="service-competencies-title">Real Estate Insurance in the Costa del Sol</h2><p class="service-grey-text">For property owners in this beautiful yet weather-exposed region, insurance is an essential aspect of safeguarding investments. Coverage typically includes:<br>      </p><h2 class="service-competencies-title"></h2><li class="service-grey-text li-test"><span class="service-competencies-span">Weather Damage: </span>
     Protecting against potential damage from coastal weather, such as flooding and storms.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Rental Protection: </span>
     Liability insurance is important for owners who rent their properties to tourists, providing coverage in the event of injuries or legal disputes.
        </li><h2 class="service-competencies-title"></h2><h2 class="service-competencies-title">Choosing the Right Insurance with ProPart</h2><p class="service-grey-text">ProPart specializes in providing tailored insurance solutions that meet the specific needs of each client, whether they are expatriates, property owners, students, or tourists. Our services include:<br>      </p><h2 class="service-competencies-title"></h2><li class="service-grey-text li-test"><span class="service-competencies-span">Expert Guidance: </span>
     We help you select the insurance type that best meets your personal and financial requirements, ensuring compliance with Spanish regulations.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Comparison of Policies: </span>
    Our experts compare multiple offers from leading insurers to find the most suitable coverage for your needs.
        </li><li class="service-grey-text li-test"><span class="service-competencies-span">Comprehensive Coverage: </span>
    From health to property and car insurance, our policies are designed to offer the best protection and peace of mind.
        </li><h2 class="service-competencies-title"></h2><div class="service-wrapper"></div></ul></div><div class="service-right"><div class="service-right-top">
	...
	<div class="service-right-bottom slider-wrapper">
		<div class="cards-container" style="transform: translateX(0%);">
		</div>
	</div>
	</div>
	</div>
    ...
    return card;
	  ...
	  try{
		    ...
		    cards_container.innerHTML = ""
		           projectData.projects[0]?.map(item=>cards_container.appendChild(createCard(item)))
