    ...
    <main class="areaPage" id="main-content">
        ...
        <section class="about-area-parent"> 
                ...
                <div class="estepona-a-charming">
                    Considered unofficially as the capital of the western Costa del Sol, there is no doubting the fact that 
                    Estepona has all the qualities required to merit its position as one of Spain's premier tourist resorts.
                    Its privileged location, at the foot of the Sierra Blanca and on the coast, create an excellent climate and
                     a landscape of immense beauty.The town dates back to Roman times, a period from which abundant archaeological remains are to be found.
                </div>
        </section>

        <section class="area-photo">
            <img class="area-photo-item" id = "first-area" alt="photo1" src="<?php echo get_template_directory_uri(); ?>/images/esteponapage/area/photo1.webp"> 
            <img class="area-photo-item" alt="photo2" src="<?php echo get_template_directory_uri(); ?>/images/esteponapage/area/photo2.webp">
            <img class="area-photo-item" alt="photo3" src="<?php echo get_template_directory_uri(); ?>/images/esteponapage/area/photo3.webp">
        </section>
        ...
        <section class="history-parent">
            ...
            <div class="text-blocks-history">
                <div class="text-history-part">
                    Prehistoric remains have been discovered from both the Palaeolithic period,
                     at a location known as Coto de Correa in Las Chapas, and the Neolithic period,
                      in Pecho Redondo cave in the foothills of the Sierra Blanca. The town"s origins
                       may have been the 1st-century Roman settlement of Barbesula. Archaeological remains from 
                       this era are to be found at the mouth of the River Verde.
                </div> 
                <div class="text-history-part2">
                    Near San Pedro de Alcantara, which is also part of the municipality, there are remains of the Roman 
                    colony of Cilniana -apparently destroyed by an earthquake in the 4th century-, one of the most interesting
                     sites on the Malaga coast, which some historians equate with the city of Salduba mentioned by Pomponius Mela. 
                     Roman baths known as Las Bovedas can be found close to the beach.
                </div>
                <div class="text-history-part3">
                    <br> Another important archaeological site in San Pedro de Alcantara is the Palaeo-Christian basilica at Vega del Mar,
                     built in the 3rd century and later used as a necropolis by the Visigoths. In the Andalusi-Arabic period, 
                     the town stood on the site of the present-day centre of Estepona and played an important role in local history. 
                     During the time of the Taifa kingdoms, the idrisies (city governors) were constantly in conflict with the Hammudies
                      of Algeciras, until the arrival of the Benimerines (1274) who, after taking Estepona and Malaga, unified the AREA.
                    </br>  

                     <br>During Nazari times, Estepona was part of the kingdom of Granada, a situation which persisted until its conquest
                       by the Catholic Monarchs in 1485. Relics of this period in the old centre of Estepona are remains of the castle walls 
                       and two defensive towers.
                       </br>
                       <br>  A new stimulus, which was to change forever the whole face of Estepona, 
                       San Pedro de Alcantara and the rest of the municipal AREA, as well as its inhabitants" economic activities and way of life,
                        came in the second half of the 20th century, when the progressive development of tourism, which had begun in 1960s,
                         transformed the town into one of the world"s leading holiday resorts.
                        </br>
                </div>
        ...
        <section class="photo-gallery-parent">
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/esteponapage/entertainment/art1.webp">
                <div class="name-art-gallery">Shopping in Puerto Banús</div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/esteponapage/entertainment/art2.webp">
                <div class="name-art-gallery">Beach Club Resorts</div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/esteponapage/entertainment/art3.webp">
                <div class="name-art-gallery">Coastal Golden Mile</div>
            </div>
            <div class="photo-gallery-group"  id="last-enter-ph">
                <img class="photo-gallery-item"  alt="" src="<?php echo get_template_directory_uri(); ?>/images/esteponapage/entertainment/art4.webp">
                <div class="name-art-gallery">Puente Romano Resort</div>
            </div>
        </section>
        ...
        <section class="top-entertainment-parent">
            ...
            <div class="top-entertainment-text">
                Estepona boasts a diverse selection of top restaurants, offering everything from traditional 
                Andalusian cuisine to international gourmet experiences. Whether dining along the marina or in the
                 charming old town, you'll discover exquisite culinary delights—from fresh seafood and tapas bars to
        ...
        <section class="photo-gallery-parent">
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/esteponapage/restaurants/rest1.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">BACK</div>
                    <div class="descr-name-gallery">1 star Michelin</div>
                </div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/esteponapage/restaurants/rest2.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">Skina</div>
                    <div class="descr-name-gallery">2 star Michelin</div>
                </div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/esteponapage/restaurants/rest3.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">Nintai</div>
                    <div class="descr-name-gallery">1 star Michelin</div>
                </div>
            </div>
            <div class="photo-gallery-group"  id="last-rest-ph">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/esteponapage/restaurants/rest4.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">Sollo</div>
                    <div class="descr-name-gallery">1 star Michelin</div>
                </div>
            </div>
        </section>
        ...
        <section class="photo-gallery-parent">
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/esteponapage/golf/golf1.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">Estepona Golf & Country Club</div>
                    <div class="descr-name-gallery"></div>
                </div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/esteponapage/golf/golf2.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">Real Club de Golf Sotogrande</div>
                    <div class="descr-name-gallery"></div>
                </div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/esteponapage/golf/golf3.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">La Hacienda Links Golf Resort</div>
                    <div class="descr-name-gallery"></div>
                </div>
            </div>
            <div class="photo-gallery-group"  id="last-golp-ph">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/esteponapage/golf/golf4.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">La Zagaleta (Old)</div>
                    <div class="descr-name-gallery"></div>
                </div>
            </div>
        </section>
        ...
        <section class="photo-gallery-parent">
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/esteponapage/sport/sport1.webp">
                <div class="name-art-gallery">Windsurfing</div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/esteponapage/sport/sport2.webp">
                <div class="name-art-gallery">Kite surfing</div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/esteponapage/sport/sport3.webp">
                <div class="name-art-gallery">Surfing</div>
            </div>
            <div class="photo-gallery-group"  id="last-sport-ph">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/esteponapage/sport/sport4.webp">
        ...
        <section class="invest-parent">
            <div class="invest-column"> 
                ...
                <div class="mob-person">
                    <img class="peop-mob-icon" alt="" src="<?php echo get_template_directory_uri(); ?>/images/esteponapage/people/peop-mob1.svg">
            ...
            <div class="people-column">
                <img class="people-photo" alt="" src="<?php echo get_template_directory_uri(); ?>/images/esteponapage/people/people1.png">
                <img class="people-photo2" alt="" src="<?php echo get_template_directory_uri(); ?>/images/esteponapage/people/people2.png">
                <img class="people-photo2" alt="" src="<?php echo get_template_directory_uri(); ?>/images/esteponapage/people/people3.png"> 
            </div>
        </section>
		...
		<section class="projects-parent"> 
			...
			<div class="projects-card-group-areas" id="projectsAreaEstepona"></div>
			<span class="projects-card-group-text" id="projectsAreaTextEstepona"></span>
		</section>
    </main>
    <script>
const areasData = [
    ...
    },
    {
        ...
        "subAreas": [
            ...
            { "value": "Bahía de Estepona", "label": "Bahía de Estepona" },
            { "value": "Marbesa", "label": "Marbesa" },
            { "value": "Cabopino", "label": "Cabopino" },
            { "value": "Reserva de Estepona", "label": "Reserva de Estepona" },
  ...
  async function fetchSecondaryProjectsArea() {
    try {
            ...
            const projectsContainer = document.getElementById(
                "projectsAreaEstepona"
            );
			const projectsAreaText = document.getElementById("projectsAreaTextEstepona");
          ...
          <div class="frame-container">
            <div class="frame-div">
              <div class="marein-natura-parent">
                ...
                <div class="estepona-spain">${generalInfo.province}, Spain</div>
              </div>
              <div class="parent">
