    ...
    <main class="areaPage" id="main-content">
        ...
        <section class="about-area-parent"> 
                ...
                <div class="estepona-a-charming">
                 <br>   This village dates back to Roman times, as is amply witnessed to by the remains that have been discovered on 
                    the hillside near the local parish church, and at many other spots nearby.  </br> 
                    <br>     It was already known as Tarnisa or Tarmina in Roman times and even then it must have been a prosperous place
                     due to the proximity of the highway that connected Malaga and Cadiz.  </br> 
                </div>
        </section>

        <section class="area-photo">
            <img class="area-photo-item" id = "first-area" alt="photo1" src="<?php echo get_template_directory_uri(); ?>/images/mijaspage/area/photo1.webp"> 
            <img class="area-photo-item" alt="photo2" src="<?php echo get_template_directory_uri(); ?>/images/mijaspage/area/photo2.webp">
            <img class="area-photo-item" alt="photo3" src="<?php echo get_template_directory_uri(); ?>/images/mijaspage/area/photo3.webp">
        </section>
        ...
        <section class="history-parent">
            ...
            <div class="text-blocks-history">
                ...
                <div class="text-history-part3">
                    <br> 
                    For their faithfulness to “Juana la Loca” during the “Guerra de las Communidades” Mijas was granted the title of “Villa” in 1512. 
                    They were also awarded a total exemption on the payments of sales tax as an extra reward. Later on, the town was honoured by 
                    the Queen and named “Muy Leal” (A very loyal town).
                    Mijas is one of the largest municipalities in terms of land in the whole province of Malaga, with more than 147 square kilometres 
                    of land that includes some wonderful mountainous areas right down to its 14 kilometres of Mediterranean coastline. 
                    There are many relics from past Eras along the coast, too such as the watchtowers at Calahonda, Calaburra, La Nueva and the Vieja
                     in the Cala del Moral.
                    </br>  

                     <br>
                     The municipality is divided up into three separate parts; Mijas Pueblo, Las Lagunas and La Cala, as well as some rural
                      hamlets like Valtocado, la Alquerîa y Entrerrîos. On top of this , there are also some 150 small housing estates spread 
                      out within the municipal boundaries. Mijas Pueblo is situated on the side of one of the many mountains some 428 metres above sea level. 
                      Its rather elevated position gave it an enormous strategic advantage for the defence of the area in past times.
                    </br> 
                </div>
        ...
        <section class="photo-gallery-parent">
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/mijaspage/restaurants/rest1.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">La Estancia - Argentinian Steak House</div>
                    <div class="descr-name-gallery">Steakhouse</div>
                </div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/mijaspage/restaurants/rest2.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">Palmito</div>
                    <div class="descr-name-gallery">Andalusian</div>
                </div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/mijaspage/restaurants/rest3.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">Restaurante Pil Pil</div>
                    <div class="descr-name-gallery">Seafood</div>
                </div>
            </div>
            <div class="photo-gallery-group"  id="last-rest-ph">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/mijaspage/restaurants/rest4.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">Oro Negro</div>
                    <div class="descr-name-gallery">Mediterranean</div>
                </div>
            </div>
        </section>
        ...
        <section class="photo-gallery-parent">
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/mijaspage/golf/golf1.webp">
                <div class="name-and-desc"> 
            ...
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/mijaspage/golf/golf2.webp">
                <div class="name-and-desc"> 
            ...
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/mijaspage/golf/golf3.webp">
                <div class="name-and-desc"> 
            ...
            <div class="photo-gallery-group"  id="last-golp-ph">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/mijaspage/golf/golf4.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">El Paraiso Golf Club</div>
                    <div class="descr-name-gallery">7:00 AM - 7:30 PM</div>
                </div>
        ...
        <section class="photo-gallery-parent">
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/mijaspage/sport/sport1.webp">
                <div class="name-art-gallery">Windsurfing</div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/mijaspage/sport/sport2.webp">
                <div class="name-art-gallery">Kite surfing</div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/mijaspage/sport/sport3.webp">
                <div class="name-art-gallery">Surfing</div>
            </div>
            <div class="photo-gallery-group"  id="last-sport-ph">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/mijaspage/sport/sport4.webp">
        ...
        <section class="invest-parent">
            <div class="invest-column"> 
                <div class="text-invest">Why you should invest in Mijas</div>


                <div class="mob-person">
                    <img class="peop-mob-icon" alt="" src="<?php echo get_template_directory_uri(); ?>/images/mijaspage/people/peop-mob1.svg">
            ...
            <div class="people-column">
                <img class="people-photo" alt="" src="<?php echo get_template_directory_uri(); ?>/images/mijaspage/people/people1.png">
                <img class="people-photo2" alt="" src="<?php echo get_template_directory_uri(); ?>/images/mijaspage/people/people2.png">
                <img class="people-photo2" alt="" src="<?php echo get_template_directory_uri(); ?>/images/mijaspage/people/people3.png"> 
            </div>
        </section>
...
<section class="projects-parent">  
	<div class="top-project-name">Explore Top projects in Mijas
	...
	<div class="projects-card-group-areas" id="projectsAreaMijas"></div>
	<span class="projects-card-group-text" id="projectsAreaTextMijas"></span>
</section>
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  footerContainer.appendChild(Footer());
    ...
    try {
			...
			const projectsAreaText = document.getElementById("projectsAreaTextMijas");
