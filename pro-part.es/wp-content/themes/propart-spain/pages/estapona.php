    ...
    <main class="areaPage" id="main-content">
        ...
        <section class="headerArea">
            <div class="AreaContent">
              ...
              <div class="estepona">Estepona</div> 
        ...
        <section class="about-area-parent">  
                ...
                <div class="estepona-a-charming">
                    Estepona, a charming town on Spain's Costa del Sol, is famous for its golden beaches, vibrant marina, 
                    and quaint old town filled with whitewashed houses, cobblestone streets, and colorful flowers.
                    It blends traditional Andalusian culture with modern luxury, offering a variety of leisure activities
                    like water sports, golf, and nature parks. With its mild climate and close proximity to Marbella and Málaga,
                    Estepona is perfect for a peaceful seaside lifestyle or a relaxing holiday.
                </div>
        </section>

        <section class="area-photo">
            <img class="area-photo-item" id = "first-area" alt="photo1" src="<?php echo get_template_directory_uri(); ?>/images/areapage/area/photo1.webp"> 
            <img class="area-photo-item" alt="photo2" src="<?php echo get_template_directory_uri(); ?>/images/areapage/area/photo2.webp">
            <img class="area-photo-item" alt="photo3" src="<?php echo get_template_directory_uri(); ?>/images/areapage/area/photo3.webp">
        </section>

        <section class="history-parent">
            <div class="backText" id="hist_text">History</div>
            <div class="history">History</div>
            <div class="text-blocks-history">
                <div class="text-history-part">
                    Estepona's history stretches back thousands of years, with archaeological evidence showing
                    that it was inhabited by early Phoenicians, Romans, and later, Moors, each civilization leaving its 
                    distinctive influence on the area. Under Roman rule, it was known as Salduba, a settlement centered 
                    around fishing and trade. The Romans constructed roads, villas, and other infrastructure that laid the
                    groundwork for future growth. During the Moorish period, Estepona was fortified with a castle and defensive
                    walls, and the town became known as Estebbuna, which is likely the origin of its current name. 
                    The Moors also developed agriculture, introducing advanced irrigation techniques that boosted local farming.
                </div> 
                <div class="text-history-part2">
                    In 1456, Estepona was captured by Christian forces during the Reconquista, and the town was almost entirely destroyed in the fighting. 
                    It was later rebuilt by the Catholic Monarchs, who established a new Christian community and constructed a church on the site of 
                    a former mosque. Estepona gradually developed into a modest agricultural and fishing village, known for its fertile land
                    and access to the sea.
                </div>
                <div class="text-history-part3">
                    During the 18th and 19th centuries, Estepona's economy slowly expanded, but it remained relatively isolated
                    and quiet compared to nearby coastal towns. It wasn’t until the mid-20th century that Estepona began to transform 
                    significantly, spurred by the development of the Costa del Sol as a major tourist destination. 
                    The town managed to preserve much of its historic charm and traditional Andalusian character, 
                    even as it embraced modern amenities and infrastructure to cater to a growing number of visitors and residents.
                    Today, Estepona is a thriving coastal town that celebrates its rich history while enjoying the benefits of contemporary development.
                </div>
        ...
        <section class="top-entertainment-parent">
            ...
            <div class="top-entertainment-text">
                Estepona offers diverse entertainment, from fishing trips and vibrant festivals in the historic old town to art galleries, museums,
                and theaters. Nature lovers can explore the Sierra Bermeja mountains with hiking and biking trails, while families enjoy Selwo 
                Aventura wildlife park. The town's promenades and beaches are perfect for relaxing strolls, sunbathing, and taking in the Mediterranean views.
            </div> 
        </section>

        <section class="photo-gallery-parent">
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/areapage/entertainment/art1.webp">
                <div class="name-art-gallery">Salduna Beach</div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/areapage/entertainment/art2.webp">
                <div class="name-art-gallery">Trocadero Estepona</div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/areapage/entertainment/art3.webp">
                <div class="name-art-gallery">Spiler Beach Club</div>
            </div>
            <div class="photo-gallery-group"  id="last-enter-ph">
                <img class="photo-gallery-item"  alt="" src="<?php echo get_template_directory_uri(); ?>/images/areapage/entertainment/art4.webp">
        ...
        <section class="top-entertainment-parent">
            ...
            <div class="top-entertainment-text">
                Estepona boasts a diverse selection of top restaurants, offering everything from traditional Andalusian cuisine to international dishes. 
                Along the marina and in the charming old town, you’ll find seafood restaurants, tapas bars, and fine dining options.
            </div> 
        </section>

        <section class="photo-gallery-parent">
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/areapage/restaurants/rest1.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">Kabuki Raw</div>
                    <div class="descr-name-gallery">Asian</div>
                </div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/areapage/restaurants/rest2.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">Claro!</div>
                    <div class="descr-name-gallery">Malagueño BBQ</div>
                </div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/areapage/restaurants/rest3.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">Trocadero Estepona</div>
                    <div class="descr-name-gallery">Spanish cuisine with a Mexican/Andalucian section</div>
                </div>
            </div>
            <div class="photo-gallery-group"  id="last-rest-ph">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/areapage/restaurants/rest4.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">Salduna Beach</div>
                    <div class="descr-name-gallery">Spanish with a nod to Asia</div>
                </div>
            </div>
        </section>
        ...
        <section class="top-entertainment-parent">
            ...
            <div class="top-entertainment-text">
                Estepona boasts several top-tier golf clubs, including Estepona Golf and Valle Romano Golf, with stunning views of the Mediterranean and mountains.
                These courses offer excellent facilities and challenges for golfers of all skill levels, making Estepona a prime destination for golf lovers on the Costa del Sol.
            </div> 
        </section>

        <section class="photo-gallery-parent">
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/areapage/golf/golf1.webp">
                <div class="name-and-desc"> 
            ...
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/areapage/golf/golf2.webp">
                <div class="name-and-desc"> 
            ...
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/areapage/golf/golf3.webp">
                <div class="name-and-desc"> 
            ...
            <div class="photo-gallery-group"  id="last-golp-ph">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/areapage/golf/golf4.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">El Paraiso Golf Club</div>
                    <div class="descr-name-gallery">7:00 AM - 7:30 PM</div>
                </div>
        ...
        <section class="top-entertainment-parent">
            ...
            <div class="top-entertainment-text">
                In Estepona, water sports offer a wide range of activities. You can enjoy kite surfing, windsurfing, surfing, and SUP boarding.
                Diving and snorkeling are also popular due to the clear waters and rich marine life. Fishing enthusiasts can choose between sea
                and freshwater fishing. Local beaches and specialized centers provide equipment rental and lessons for all skill levels.
            </div> 
        </section>

        <section class="photo-gallery-parent">
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/areapage/sport/sport1.webp">
                <div class="name-art-gallery">Windsurfing</div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/areapage/sport/sport2.webp">
                <div class="name-art-gallery">Kite surfing</div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/areapage/sport/sport3.webp">
                <div class="name-art-gallery">Surfing</div>
            </div>
            <div class="photo-gallery-group"  id="last-sport-ph">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/areapage/sport/sport4.webp">
        ...
        <section class="invest-parent">
            <div class="invest-column"> 
                <div class="text-invest">Why you should invest in Estepona</div>


                <div class="mob-person">
                    <img class="peop-mob-icon" alt="" src="<?php echo get_template_directory_uri(); ?>/images/areapage/people/peop-mob1.svg">
            ...
            <div class="people-column">
                <img class="people-photo" alt="" src="<?php echo get_template_directory_uri(); ?>/images/areapage/people/people1.png">
                <img class="people-photo2" alt="" src="<?php echo get_template_directory_uri(); ?>/images/areapage/people/people2.png">
                <img class="people-photo2" alt="" src="<?php echo get_template_directory_uri(); ?>/images/areapage/people/people3.png"> 
            </div>
        </section>

       
        <div class="backText">Top projects</div>
        <section class="projects-parent"> 
            <div class="top-project-name">Explore Top projects in Estepona
			...
			<div class="projects-card-group-areas" id="projectsAreaEstapona"></div>
			<span class="projects-card-group-text" id="projectsAreaTextEstapona"></span>
        </section>
  ...
  footerContainer.appendChild(Footer());
    ...
    try {
            ...
            const projectsContainer = document.getElementById(
                "projectsAreaEstapona"
            );
			const projectsAreaText = document.getElementById("projectsAreaTextEstapona");
