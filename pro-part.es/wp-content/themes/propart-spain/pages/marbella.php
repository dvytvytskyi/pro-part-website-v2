    ...
    <main class="areaPage" id="main-content">
        ...
        <section class="headerMarbella">
            <div class="AreaContent">
              ...
              <div class="estepona">Marbella</div> 
        ...
        <section class="about-area-parent"> 
                ...
                <div class="estepona-a-charming">
                    ...
                    Marbella has all the qualities required to merit its position as one of Spain's premier tourist resorts.
        ...
        <section class="area-photo">
            <img class="area-photo-item" id = "first-area" alt="photo1" src="<?php echo get_template_directory_uri(); ?>/images/marbellapage/area/photo1.webp"> 
            <img class="area-photo-item" alt="photo2" src="<?php echo get_template_directory_uri(); ?>/images/marbellapage/area/photo2.webp">
            <img class="area-photo-item" alt="photo3" src="<?php echo get_template_directory_uri(); ?>/images/marbellapage/area/photo3.webp">
        </section>
            ...
            <div class="text-blocks-history">
                ...
                <div class="text-history-part3">
                    <br> Another important archaeological site in San Pedro de Alcantara is the Palaeo-Christian basilica at Vega del Mar,
                     ...
                     the town stood on the site of the present-day centre of Marbella and played an important role in local history. 
                     During the time of the Taifa kingdoms, the idrisies (city governors) were constantly in conflict with the Hammudies
                      of Algeciras, until the arrival of the Benimerines (1274) who, after taking Marbella and Malaga, unified the AREA.
                    </br>  

                     <br>During Nazari times, Marbella was part of the kingdom of Granada, a situation which persisted until its conquest
                       by the Catholic Monarchs in 1485. Relics of this period in the old centre of Marbella are remains of the castle walls 
                       and two defensive towers.
                       </br>
                       <br>  A new stimulus, which was to change forever the whole face of Marbella, 
        ...
        <section class="photo-gallery-parent">
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/marbellapage/entertainment/art1.webp">
                <div class="name-art-gallery">Shopping in Puerto Banús</div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/marbellapage/entertainment/art2.webp">
                <div class="name-art-gallery">Beach Club Resorts</div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/marbellapage/entertainment/art3.webp">
                <div class="name-art-gallery">Coastal Golden Mile</div>
            </div>
            <div class="photo-gallery-group"  id="last-enter-ph">
                <img class="photo-gallery-item"  alt="" src="<?php echo get_template_directory_uri(); ?>/images/marbellapage/entertainment/art4.webp">
        ...
        <section class="top-entertainment-parent">
            ...
            <div class="top-entertainment-text">
                Marbella boasts a diverse selection of top restaurants, offering everything from traditional 
        ...
        <section class="photo-gallery-parent">
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/marbellapage/restaurants/rest1.webp">
            ...
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/marbellapage/restaurants/rest2.webp">
                <div class="name-and-desc"> 
            ...
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/marbellapage/restaurants/rest3.webp">
                <div class="name-and-desc"> 
            ...
            <div class="photo-gallery-group"  id="last-rest-ph">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/marbellapage/restaurants/rest4.webp">
                <div class="name-and-desc"> 
        ...
        <section class="photo-gallery-parent">
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/marbellapage/golf/golf1.webp">
                <div class="name-and-desc"> 
                    <div class="name-art-gallery">Marbella Golf & Country Club</div>
                    <div class="descr-name-gallery"></div>
                </div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/marbellapage/golf/golf2.webp">
                <div class="name-and-desc"> 
            ...
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/marbellapage/golf/golf3.webp">
                <div class="name-and-desc"> 
            ...
            <div class="photo-gallery-group"  id="last-golp-ph">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/marbellapage/golf/golf4.webp">
                <div class="name-and-desc"> 
        ...
        <section class="photo-gallery-parent">
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/marbellapage/sport/sport1.webp">
                <div class="name-art-gallery">Windsurfing</div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/marbellapage/sport/sport2.webp">
                <div class="name-art-gallery">Kite surfing</div>
            </div>
            <div class="photo-gallery-group">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/marbellapage/sport/sport3.webp">
                <div class="name-art-gallery">Surfing</div>
            </div>
            <div class="photo-gallery-group"  id="last-sport-ph">
                <img class="photo-gallery-item" alt="" src="<?php echo get_template_directory_uri(); ?>/images/marbellapage/sport/sport4.webp">
        ...
        <section class="invest-parent">
            <div class="invest-column"> 
                <div class="text-invest">Why you should invest in Marbella</div>


                <div class="mob-person">
                    <img class="peop-mob-icon" alt="" src="<?php echo get_template_directory_uri(); ?>/images/marbellapage/people/peop-mob1.svg">
            ...
            <div class="people-column">
                <img class="people-photo" alt="" src="<?php echo get_template_directory_uri(); ?>/images/marbellapage/people/people1.png">
                <img class="people-photo2" alt="" src="<?php echo get_template_directory_uri(); ?>/images/marbellapage/people/people2.png">
                <img class="people-photo2" alt="" src="<?php echo get_template_directory_uri(); ?>/images/marbellapage/people/people3.png"> 
            </div>
        </section>
		...
		<section class="projects-parent"> 
			...
			<div class="top-project-name">Explore Top projects in Marbella
			...
			<div class="projects-card-group-areas" id="projectsAreaMarbella"></div>
			<span class="projects-card-group-text" id="projectsAreaTextMarbella"></span>
		</section>
    </main>
    <script>
const areasData = [
  ...
  async function fetchSecondaryProjectsArea() {
    try {
            ...
            const projectsContainer = document.getElementById(
                "projectsAreaMarbella"
            );
			const projectsAreaText = document.getElementById("projectsAreaTextMarbella");
